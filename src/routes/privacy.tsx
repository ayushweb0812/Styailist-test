    ...
    <main className="min-h-screen bg-background overflow-x-hidden flex flex-col relative z-0">
      ...
      <div className="flex-1 max-w-4xl mx-auto w-full px-6 pt-36 pb-24">
        <div className="bg-glass-strong ring-glass shadow-card rounded-[2.5rem] p-8 md:p-14 relative">
          ...
          <p className="text-sm font-medium tracking-widest text-foreground/50 uppercase mb-10 border-b border-foreground/10 pb-6">
          ...
          <div className="space-y-10 text-foreground/75 leading-relaxed relative z-10 text-base md:text-lg">
            <p className="text-sm text-foreground/70 mb-8 italic">
              At Sty<span className="text-[#AC1559]">ai</span>list, These Terms shall be governed by and construed in accordance with the
              laws of India.
            ...
            <section className="group">
              <h2 className="text-xl md:text-2xl font-semibold text-ink mb-3 text-neon-pink">
              ...
              <div className="space-y-4">
                <p>
                  ...
                  reach out for business inquiries, or apply for career opportunities at Sty<span className="text-[#AC1559]">ai</span>list.
                ...
                <p>
                  ...
                  trusted service providers who help us with operations such as:
                </p>
                <ul className="list-disc pl-6 space-y-1">
                ...
                <p>
                  We may also track which pages are accessed most often to understand what interests
                  our users. This helps us present relevant services and content to you. We will
                  only disclose your personal information when required by law or if we believe it's
                  necessary to protect our rights or comply with legal obligations.
                </p>
              </div>
            </section>

            <section className="group pt-4">
              <h2 className="text-xl md:text-2xl font-semibold text-ink mb-3 text-neon-purple">
                Cookies
              </h2>
              ...
              <p>
                ...
                help us understand user behavior, improve website functionality, and personalize
                your experience.
                <br />
                You can choose to disable cookies through your browser settings. However, doing so
                may limit access to some features of our website. For the best experience, we
                recommend keeping cookies enabled.
              </p>
            </section>
            ...
            <section className="group pt-4">
              ...
              <div className="space-y-4">
                <p>
                  We may offer email newsletters to keep you updated on our latest services,
                  insights, and announcements. To subscribe, you'll need to share your email and
                ...
                <p>
                  Your information is used exclusively for newsletter delivery. You can unsubscribe
                  at any time by following the instructions in the email. Upon unsubscribing, your
                  data is permanently removed from our mailing system.
                </p>
                <p>
                  Our blog may include articles, discussions, and insights. Comments made on the
                  blog are public and can be viewed or shared by other users. Please avoid sharing
                  sensitive personal information in the comment sections.
                </p>
              </div>
            </section>
            ...
            <section className="group pt-4">
              ...
              <p className="mb-4">
                Sty<span className="text-[#AC1559]">ai</span>list uses analytics tools like Google Analytics to understand how users
            ...
            <section className="group pt-4">
              ...
              <p className="mb-4">
                By visiting and using our website or services, you consent to this Privacy Policy.
                If you do not agree with any part of it, please discontinue use of the website.
              </p>
              <p>
                We reserve the right to update or change this policy at any time. All updates will
                be reflected on this page. Continued use of our website after changes are posted
            ...
            <section className="group pt-4">
              ...
              <p className="mb-4">
                If you have questions, concerns, or requests related to this Privacy Policy, feel
                free to reach out:
              </p>
