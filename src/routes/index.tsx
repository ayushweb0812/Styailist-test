...
const Struggles = React.lazy(() =>
  import("@/components/site/Struggles").then((m) => ({ default: m.Struggles })),
);
const Problem = React.lazy(() =>
...
const HowItWorks = React.lazy(() =>
  import("@/components/site/HowItWorks").then((m) => ({ default: m.HowItWorks })),
);
const TryIt = React.lazy(() =>
  import("@/components/site/TryIt").then((m) => ({ default: m.TryIt })),
);
