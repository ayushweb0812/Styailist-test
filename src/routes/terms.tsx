        ...
        <div className="bg-glass-strong ring-glass shadow-card rounded-[2.5rem] p-8 md:p-14 relative">
          ...
          <div className="space-y-10 text-foreground/75 leading-relaxed relative z-10 text-base md:text-lg">
            <p className="text-sm text-foreground/70 mb-8 italic">
              Welcome to Styailist. These Terms & Conditions govern your access to and use of our
            ...
            <section className="group">
              ...
              <div className="space-y-4">
                <p>
                  You may use the ClosetCrew website for lawful purposes only. You agree not to:
                </p>
            ...
            <section className="group pt-4">
              ...
              <p>
                All content, trademarks, logos, service marks, graphics, and design elements on this
                site are the property of ClosetCrew or its licensors. Unauthorized use,
                reproduction, or distribution of any content is strictly prohibited unless
            ...
            <section className="group pt-4">
              ...
              <p>
                Your use of the Website is also governed by our Privacy Policy, which outlines how
                we collect, use, and protect your data. By using the Website, you consent to the
            ...
            <section className="group pt-4">
              ...
              <div className="space-y-4">
                <p>
                  The content on the ClosetCrew website is provided for general information purposes
                  only. We do our best to ensure accuracy, but we make no guarantees about the
                  completeness, reliability, or suitability of the content for any specific purpose.
                </p>
                <p>
                  We reserve the right to make changes or updates to our services or site content at
            ...
            <section className="group pt-4">
              ...
              <p>
                To the fullest extent permitted by law, Styailist will not be liable for any direct,
            ...
            <section className="group pt-4">
              ...
              <p>
                You agree to indemnify, defend, and hold harmless Styailist, its team members, and
            ...
            <section className="group pt-4">
              ...
              <p>
                ...
                be posted on this page with an updated effective date. Your continued use of the
            ...
            <section className="group pt-4">
              ...
              <p>
                ...
                or liability, if we believe you have violated these Terms or applicable law.
              </p>
            </section>
            ...
            <section className="group pt-4">
              ...
              <p>
                ...
                <br />
                Jurisdiction: All claims arising out of or relating to these Terms or the use of the
                Services shall be subject to the exclusive jurisdiction of the courts in Ahmedabad,
                Gujarat, India.
              </p>
            </section>
