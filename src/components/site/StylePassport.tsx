      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid md:grid-cols-12 gap-8 items-end mb-14">
          <div className="md:col-span-7">
            <span className="text-[11px] uppercase tracking-[0.25em] text-foreground/55 font-medium">— Style Passport —</span>
            <motion.h2
            ...
            >
              Every shopper gets a{" "}
              <span className="text-gradient-primary">living profile.</span>
            </motion.h2>
          </div>
          <div className="md:col-span-4 md:col-start-9">
            <p className="text-foreground/65 leading-relaxed">
              Context, colour, fit, mood — read in real time and refined with every visit.
              Their stylist remembers, so your catalogue never has to start over.
            </p>
          </div>
        </div>
        ...
        >
          {/* grid bg */}
          <div className="absolute inset-0 opacity-[0.04]" style={{ backgroundImage: "linear-gradient(var(--ink) 1px, transparent 1px), linear-gradient(90deg, var(--ink) 1px, transparent 1px)", backgroundSize: "60px 60px" }} />
          ...
          <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[300px] md:w-[380px] h-[480px] md:h-[560px] rounded-[36px] overflow-hidden ring-1 ring-white/40 shadow-glass">
            <div className="absolute inset-0" style={{ background: "linear-gradient(160deg, oklch(0.88 0.09 350) 0%, oklch(0.62 0.22 295) 100%)" }} />
            ...
            <div className="absolute bottom-6 inset-x-6 z-20 flex flex-col gap-4">
              <div>
                <p className="text-[10px] font-mono uppercase tracking-wider text-white/70">Style Passport · Elise · 28</p>
              ...
              <div className="flex gap-2 flex-wrap">
                {["Breathable", "Drape: high", "94% match"].map((t) => (
                  <span key={t} className="px-3 py-1.5 rounded-lg bg-white/15 backdrop-blur-md ring-1 ring-white/25 text-[11px] text-white font-medium">{t}</span>
                ))}
              </div>
            </div>
          </div>
          ...
          >
            <div className="flex items-center justify-between mb-4">
              <span className="text-[10px] font-medium text-foreground/55 uppercase tracking-wider">Context Scan</span>
          ...
          >
            <p className="text-[10px] uppercase tracking-wider text-background/55 font-mono">Conversion</p>
          ...
          >
            {["#1A1A1A", "#E5D5C6", "#8A3A4A", "#C9A4D4"].map((c) => (
              <div key={c} className="size-10 rounded-full ring-2 ring-white shadow-inner" style={{ background: c }} />
            ))}
          </motion.div>
          ...
          >
            <span className="size-8 rounded-full bg-gradient-to-br from-neon-pink to-neon-purple flex items-center justify-center text-white text-xs">★</span>
